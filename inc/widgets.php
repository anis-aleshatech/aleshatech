...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'aleshatech' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'aleshatech' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'aleshatech' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'aleshatech' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Slider', 'aleshatech' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'aleshatech' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Canvas', 'aleshatech' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'aleshatech' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				'name'          => __( 'Top Full', 'aleshatech' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'aleshatech' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'aleshatech' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'aleshatech' ),
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Sidebar 1', 'aleshatech' ),
				'id'            => 'footer-sidebar-1',
				'description'   => esc_html__( 'Add widgets here.', 'aleshatech' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s footer__widget-title">',
				'after_widget'  => '</div>',
				'before_title'  => '<h6 clas="footer__widget-title">',
				'after_title'   => '</h6>',
			)
		);
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Sidebar 2', 'aleshatech' ),
				'id'            => 'footer-sidebar-2',
				'description'   => esc_html__( 'Add widgets here.', 'aleshatech' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s footer__widget-title">',
				'after_widget'  => '</div>',
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Sidebar 3', 'aleshatech' ),
				'id'            => 'footer-sidebar-3',
				'description'   => esc_html__( 'Add widgets here.', 'aleshatech' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s footer__widget-title">',
				'after_widget'  => '</div>',
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Sidebar 4', 'aleshatech' ),
				'id'            => 'footer-sidebar-4',
				'description'   => esc_html__( 'Add widgets here.', 'aleshatech' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s footer__widget-title">',
				'after_widget'  => '</div>',
