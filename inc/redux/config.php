...
$opt_name = 'aleshatech-redux';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Theme Options', 'aleshatech' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Theme Options', 'aleshatech' ),
...
$args['admin_bar_links'][] = array(
	'id'    => 'redux-docs',
	'href'  => '//devs.redux.io/',
	'title' => __( 'Documentation', 'aleshatech' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-support',
	'href'  => '//github.com/ReduxFramework/redux-framework/issues',
	'title' => __( 'Support', 'aleshatech' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-extensions',
	'href'  => 'redux.io/extensions',
	'title' => __( 'Extensions', 'aleshatech' ),
);
...
$args['share_icons'][] = array(
	'url'   => 'https://www.facebook.com/aleshatechltd/',
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'aleshatech' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'aleshatech' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'aleshatech' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'aleshatech' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'aleshatech' ) . '</p>';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header', 'aleshatech' ),
		'id'               => 'header',
		'desc'             => esc_html__( 'Header Settings!', 'aleshatech' ),
		'customizer_width' => '400px',
		'icon'             => 'fas fa-heading',
	)
);
require_once get_template_directory()."/inc/redux/sections/header/header.php";
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Footer', 'aleshatech' ),
		'id'               => 'footer',
		'desc'             => esc_html__( 'Footer Settings!', 'aleshatech' ),
		'customizer_width' => '400px',
...
require_once get_template_directory()."/inc/redux/sections/footer/text.php";

//START Blog Fields
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Blog Settings', 'aleshatech' ),
		'id'               => 'blog',
		'desc'             => esc_html__( 'Blog Settings!', 'aleshatech' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-blogger',
	)
);
...
if ( ! function_exists( 'dynamic_section' ) ) {
	...
	function dynamic_section( array $sections ): array {
		$sections[] = array(
			'title'  => esc_html__( 'Section via hook', 'aleshatech' ),
			'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'aleshatech' ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
	...
	function change_defaults( array $defaults ): array {
		$defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'aleshatech' );
