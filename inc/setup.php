...
if ( ! function_exists( 'understrap_setup' ) ) {
	...
	function understrap_setup() {
		 ...
		 * to change 'aleshatech' to the name of your theme in all the template files
		 */
		load_theme_textdomain( 'aleshatech', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'primary' => __( 'Primary Menu', 'aleshatech' ),
